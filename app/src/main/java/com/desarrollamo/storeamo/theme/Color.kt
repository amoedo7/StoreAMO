...
private val DarkPalette = AmoPalette(
    ...
    pink = Color(0xFFF16AB5), violet = Color(0xFF8177C9), green = Color(0xFF78E6AD),
    amber = Color(0xFFFFBE58), isDark = true,
)
...
private val LightPalette = AmoPalette(
    ...
    pink = Color(0xFFC93F8A), violet = Color(0xFF625A9F), green = Color(0xFF167C52),
    amber = Color(0xFF9A5A00), isDark = false,
)

// 0.4.3.73: Solar Calm. Deep navy does the quiet work; amber carries focus.
// Violet remains part of the StoreAMO symbol, but stops competing for hierarchy.
private val AestheticPalette = AmoPalette(
    background = Color(0xFF07111F), background2 = Color(0xFF0A1728),
    surface = Color(0xFF10243A), surface2 = Color(0xFF17314B), line = Color(0xFF294965),
    text = Color(0xFFF8FBFF), muted = Color(0xFF9FB2C4), cyan = Color(0xFF65D7FF),
    pink = Color(0xFFFF70B8), violet = Color(0xFF7B75B9), green = Color(0xFF7EE6B3),
    amber = Color(0xFFFFB84D), isDark = true,
)
...
private val OledPalette = AmoPalette(
    ...
    pink = Color(0xFFFF63B6), violet = Color(0xFF8175BA), green = Color(0xFF70E6AC),
    amber = Color(0xFFFFB94F), isDark = true,
)
...
private val OceanPalette = AmoPalette(
    ...
    pink = Color(0xFF7DBBFF), violet = Color(0xFF7887B9), green = Color(0xFF62E6C1),
    amber = Color(0xFFFFC864), isDark = true,
)
...
private val SunsetPalette = AmoPalette(
    ...
    pink = Color(0xFFFF79B7), violet = Color(0xFFB38BCA), green = Color(0xFF9BE6B8),
    amber = Color(0xFFFFB95A), isDark = true,
)
