...
class UpdateBatchStateCodecTest {
    ...
    fun oldOrUnsupportedStateFailsClosed() {
        ...
        assertNull(UpdateBatchStateCodec.decode(mapOf("version" to "1", "item_count" to "0", "active_app_id" to "")))
        assertNull(UpdateBatchStateCodec.decode(mapOf("version" to "999", "item_count" to "0", "active_app_id" to "")))
    }
